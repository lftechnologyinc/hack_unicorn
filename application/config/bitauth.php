 ...
 */
$config['table'] = array(
	'users'		=> 'unicorn_users',		// Required user information (username, password, etc)
	'data'		=> 'unicorn_userdata',	// Optional user information (profile)
	'groups'	=> 'unicorn_groups',	// Groups
	'assoc'		=> 'unicorn_assoc',		// Users -> Groups associations
	'logins'	=> 'unicorn_logins'		// Record of all logins
);
